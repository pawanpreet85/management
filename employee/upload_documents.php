...
<?php $select_upload = "SELECT * from uploads where user_id='".$id."'";
...
<div class="row">
    <div class="col-md-9 col-md-offset-1">
    <div class="col-sm-1 col-xs-2"><a href="upload_documents.php?del=<?php echo $rowData['id']; ?>"><i class="fa fa-trash"></i></div>
