...
if(isset($_POST['login']))
{
    ...
    $sql = "select * from employees where email='".$emailid."' and password = '".md5($password)."'";
    ...
    if($q->num_rows==1)
    {
        ...
        $_SESSION['rainbow_employeeid']=$res['id'];
 ...
 <div class="container"     style="margin-top: 90px;">
    ...
    <form class="form-login" action="login.php" method="post" id="login-form">
       ...
       <!-- <img  src="../www.evermoltech.com/images/logo.png">-->
        <h3 class="form-login-heading "><span class="titledata" style="font-family:roboto;">STAFF LOGIN</span></h3><hr />
        <div id="error">
        </div>
