...
<body class="login-page" >
   ...
   <div class="container"     style="margin-top: 90px;">
    ...
    <center><img  src="img/logo.png"></center>
        <h3 class="form-login-heading "><span class="titledata">Manage Admin Login</span></h3><hr />
        <div id="error">
        </div>
        <div class="form-group">
            <input type="email" class="form-control" placeholder="Enter User Id" name="emailid" id="user_email" />
