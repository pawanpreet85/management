                                                    ...
                                                    <td class="center">
                                                        ...
                                                        {?>
                                                            ...
                                                            <?php } else {?>
                                                                ...
                                                                <a href="edit-manage-admin.php?id=<?php echo htmlentities($result->id);?>" class="btn btn-primary" style="background: #fff"><i class="fa fa-pencil"></i></a>
                                                                <a href="manage-admin.php?delid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Are you sure you want to delete this user?');" class="btn btn-danger"><i class="fa fa-trash"></i></a>
