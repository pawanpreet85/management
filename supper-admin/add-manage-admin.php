...
//Code for student ID
        ...
        $status=1;
        $sql="INSERT INTO  manage(ManageId,FullName,MobileNumber,EmailId,Password,Section,Status) VALUES(:ManageId,:fname,:mobileno,:email,:password,:section,:status)";
...
<div id="page-wrapper">
    <div id="page-inner">
        <div class="row">
            <div class="col-md-12">
                <h1 class="page-head-line">Add <?php echo htmlentities($section->section_name);?> Manager 
