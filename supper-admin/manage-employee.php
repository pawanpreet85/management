...
<div id="page-wrapper">
    <div id="page-inner">
        <div class="row">
            <div class="col-md-12">
                <h1 class="page-head-line"> <?php echo htmlentities($section->section_name);?> Staff  
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    <div class="row">
                      ...
                      <div class="col-md-4">
                             <a href="add-employee.php?sid=<?php echo $_GET['sid']; ?>" class="btn btn-primary" style="margin-top: 5px;">Add Staff</a>
                      </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tbody id="dynamicEmployee">
                                <?php $sql = "SELECT * from employees where section='".$_GET['sid']."'";
                                $query = $dbh -> prepare($sql);
                                $query->execute();
                                        ...
                                        {               ?>                                      
                                            <tr class="odd gradeX">
                                                ...
                                                <td class="center">
                                                    ...
                                                    {?>
                                                        <a href="manage-employee.php?sid=<?php echo $_GET['sid']; ?>&inid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Are you sure you want to block this Employee?');" >  <button class="btn btn-danger"> Inactive</button>
                                                        <?php } else {?>

                                                            <a href="manage-employee.php?sid=<?php echo $_GET['sid']; ?>&id=<?php echo htmlentities($result->id);?>" onclick="return confirm('Are you sure you want to active this Employee?');""><button class="btn btn-primary"> Active</button> 
                                                            <?php } ?>

                                                            <a href="edit-employee.php?sid=<?php echo $_GET['sid']; ?>&id=<?php echo htmlentities($result->id);?>" class="btn btn-primary" style="background: #fff"><i class="fa fa-pencil"></i></a>
                                                            <a href="manage-employee.php?sid=<?php echo $_GET['sid']; ?>&delid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Are you sure you want to delete this Employee?');" class="btn btn-danger"><i class="fa fa-trash"></i></a>
