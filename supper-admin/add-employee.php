...
$sql="INSERT INTO employees (employee_id,name,email,phone,password,status,section) VALUES(:employee_id,:name,:email,:mobileno,:password,:status,:section)";
// echo $sql; die;
$query = $dbh->prepare($sql);

$query->bindParam(':employee_id',$StudentId,PDO::PARAM_STR);
...
if($lastInsertId)
{
echo '<script>alert("Your Registration successfull and your employee id is  "+"'.$StudentId.'")</script>';
}
else 
{
...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Add New  <?php echo htmlentities($section->section_name);?> Staff
...
<a href="manage-employee.php?sid=<?php echo $_GET['sid']; ?>" name="signup" class="btn btn-primary" id="submit">Back </a>
