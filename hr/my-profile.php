...
$id = $_SESSION['rainbow_manageid'];
unset($_SESSION['message']);

if(count($_POST)>0){
    if($_POST['password']==Null){
        $update_Admin = "UPDATE manage set FullName='".$_POST['FullName']."',EmailId='".$_POST['EmailId']."',MobileNumber='".$_POST['MobileNumber']."' where id='".$id."'";
        ...
        if($_POST['password'] == $_POST['confirmpassword']){
            ...
            $update_Admin = "UPDATE manage set FullName='".$_POST['FullName']."',EmailId='".$_POST['EmailId']."',MobileNumber='".$_POST['MobileNumber']."',Password='".$password."' where id='".$id."'";
...
<div id="page-wrapper">
    <div id="page-inner">
        <div class="row">
            <div class="col-md-12">
                <h1 class="page-head-line">Manage Profile   
               ...
               <div class="panel-body">
                <form name="update" method="post" action="my-profile.php">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="MobileNumber" autocomplete="off" required value="<?=$MobileNumber?>"/>
                    </div>

                    <div class="form-group">
                        <label>Email</label>
                        <input class="form-control" type="email" name="EmailId" id="EmailId" onBlur="checkAvailability()"  autocomplete="off" required  value="<?=$EmailId?>"/>
